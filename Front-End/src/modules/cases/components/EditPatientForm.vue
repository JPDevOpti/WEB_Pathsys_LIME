<template>
  <div class="space-y-4">
    <form class="space-y-4" @submit.prevent="onSubmit">
      ...
      <!-- Mensaje informativo cuando no hay paciente -->
      ...
      <div ref="notificationContainer" v-if="notification.visible">
        ...
        >
          <!-- Contenido de la notificación de éxito -->
          <template v-if="notification.type === 'success' && updatedPatient" #content>
            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
              <div class="space-y-4">
                ...
                <!-- Detalles del paciente actualizado -->
                <div class="space-y-4">
...
const onSubmit = async () => {
  ...
  try {
    ...
    // Preparar datos para la API en el formato correcto del backend
    ...
    console.log('Datos del formulario (originales):', { sexo: form.sexo, tipoAtencion: form.tipoAtencion })
    console.log('Datos transformados para el backend:', patientUpdateData)
    console.log('Código del paciente:', pacienteCodeToUse)
...
// Limpia los campos del formulario después de guardar exitosamente
...
// Maneja cambios en el código de identificación de búsqueda
...
// Busca un paciente por código de identificación
