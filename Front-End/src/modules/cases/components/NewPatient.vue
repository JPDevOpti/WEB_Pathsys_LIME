<template>
  <ComponentCard title="Ingresar un nuevo paciente al sistema" description="Complete la información del paciente para ingresarlo al sistema.">
    ...
    <div class="space-y-6">
      ...
      <FormInputField v-model="formData.pacienteCode" label="Cédula" placeholder="Ejemplo: 12345678" :required="true" :max-length="10" :show-counter="true" :errors="errors.pacienteCode" :warnings="warnings.pacienteCode" :is-validating="false" inputmode="numeric" @input="handleCedulaInput" />
