...
export { default as EntidadIcon } from './EntidadIcon.vue'
export { default as GraficoIcon } from './GraficoIcon.vue'
export { default as MuestraIcon } from './MuestraIcon.vue'
