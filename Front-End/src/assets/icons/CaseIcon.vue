<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 6L12 8M12 8L12 10M12 8H10M12 8L14 8" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
    <path d="M8 14H16" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
    <path d="M9 18H15" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"/>
  </svg>
</template>
