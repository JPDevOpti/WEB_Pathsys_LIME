...
async def list_urgent_cases(
    ...
    min_days: int = Query(6, ge=1, le=365),
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error listing urgent cases: {str(e)}")
...
async def list_urgent_cases_by_pathologist(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error listing urgent cases by pathologist: {str(e)}")
